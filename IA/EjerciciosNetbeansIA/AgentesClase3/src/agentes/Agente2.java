    ...
    class Comportamiento extends Behaviour {
        ...
        public void action() {
            try {
                ...
                Persona per = (Persona) men.getContentObject();
                System.out.println(per);
                if (per.getNombre().equals("Leslie")){
                    Persona pers = new Persona("Traecy", "Diaz", "1725116386");
                    enviarMensaje(pers, "Agente1", "convA1A2");
                    bandera = true;
                }
