    ...
    class Comportamiento extends Behaviour {
        ...
        public void action() {
            ...
            ACLMessage men = blockingReceive();
                ...
                System.out.println("Agente 2 ha cumplido"); 
            }else if (men.getContent().equals("Deficiente")) {
                System.out.println("Agente 2 no ha cumplido");
            } 
            bandera=true;
        }
        ...
        private void llamarVentana(VentanaA2 ven){
             ven.setTitle("Agente 2");
             ven.getjLabel1().setText(ven.getjLabel1().getText() + " del Agente 2");
             ven.setVisible(true);
            ...
            if (ven.getTexto()!= ""){
               ...
               if (isNumeric(val)== true){
                    ven.dispose();
                    enviarMensaje(val, "Agente1", "convA2A1");
                    bandera = true;
               }
