...
public class Agente4 extends Agent {
    ...
    class Comportamiento extends Behaviour {
        ...
        public void action() {
            ...
            if (men.getContent().equals("Cumple")) {
                System.out.println("Agente 4 ha cumplido"); 
            }else if (men.getContent().equals("Deficiente")) {
                System.out.println("Agente 4 no ha cumplido");
            } 
            bandera=true;
        }
 ...
 private void llamarVentana(VentanaA2 ven){
             ven.setTitle("Agente 4");
             ven.getjLabel1().setText(ven.getjLabel1().getText() + " del Agente 4");
             ven.setVisible(true);
            ...
            if (ven.getTexto()!= ""){
               ...
               if (isNumeric(val)== true){
                    ven.dispose();
                    enviarMensaje(val, "Agente1", "convA4A1");
                    bandera = true;
               }
