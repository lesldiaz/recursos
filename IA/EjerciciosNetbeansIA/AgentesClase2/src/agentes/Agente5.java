...
public class Agente5 extends Agent {
    ...
    class Comportamiento extends Behaviour {
        ...
        public void action() {
            ...
            ACLMessage men = blockingReceive();
                ...
                System.out.println("Agente 5 ha cumplido"); 
            }else if (men.getContent().equals("Deficiente")) {
                System.out.println("Agente 5 no ha cumplido");
            } 
            bandera=true;
        }
  ...
  private void llamarVentana(){
             ...
             ven.setTitle("Agente 5");
             ven.getjLabel1().setText(ven.getjLabel1().getText() + " del Agente 5");
             ven.setVisible(true);
             while (ven.getTexto().equals("")){
               ...
               if (isNumeric(val)== true){
                    ven.dispose();
                    enviarMensaje(val, "Agente1", "convA5A1");
                    bandera = true;
               }
