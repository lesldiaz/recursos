...
public class Agente8 extends Agent {
    ...
    class Comportamiento extends Behaviour {
        ...
        public void action() {
            ...
            ACLMessage men = blockingReceive();
                ...
                System.out.println("Agente 8 ha cumplido"); 
            }else if (men.getContent().equals("Deficiente")) {
                System.out.println("Agente 8 no ha cumplido");
            } 
            bandera=true;
        }
  ...
  private void llamarVentana(){
             ...
             ven.setTitle("Agente 8");
             ven.getjLabel1().setText(ven.getjLabel1().getText() + " del Agente 8");
             ven.setVisible(true);
            ...
            if (ven.getTexto()!= ""){
               ...
               if (isNumeric(val)== true){
                    ven.dispose();
                    enviarMensaje(val, "Agente1", "convA8A1");
                    bandera = true;
               }
