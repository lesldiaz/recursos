...
public class Agente6 extends Agent {
    ...
    class Comportamiento extends Behaviour {
        ...
        public void action() {
            ...
            ACLMessage men = blockingReceive();
                ...
                System.out.println("Agente 6 ha cumplido"); 
            }else if (men.getContent().equals("Deficiente")) {
                System.out.println("Agente 6 no ha cumplido");
            } 
            bandera=true;
        }
  ...
  private void llamarVentana(){
             ...
             ven.setTitle("Agente 6");
             ven.getjLabel1().setText(ven.getjLabel1().getText() + " del Agente 6");
             ven.setVisible(true);
            ...
            if (ven.getTexto()!= ""){
               ...
               if (isNumeric(val)== true){
                    ven.dispose();
                    enviarMensaje(val, "Agente1", "convA6A1");
                    bandera = true;
               }
