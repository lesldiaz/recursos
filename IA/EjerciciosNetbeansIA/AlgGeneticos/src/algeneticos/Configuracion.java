...
private static final int ITERACIONES = 60; //Generaciones
private MostrarIndividuos mi = new MostrarIndividuos();
    ...
    private Gene[] genesEjemplo (Configuration confg){
       Gene[] ejemplo = new Gene[10]; // la longitud depende del problema al que quiero llegar Ejem: X2 + Y2, depende del dominio |Signo|x|x|x|x|Signo|y|y|y|y|
        try {
