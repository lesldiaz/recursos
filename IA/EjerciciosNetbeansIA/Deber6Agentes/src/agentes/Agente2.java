...
public class Agente2 extends Agent {
    ...
    class Comportamiento extends Behaviour {
        ...
        public void action() {
            ...
            if (mensaje.getConversationId().equals("convA4A2")) {
                int suma = Integer.parseInt(mensaje.getContent()) + ran;
                enviarMensaje(suma + "", mensaje.getSender().getLocalName(), "convA4A2");
                bandera = true;//doDelete(); para matarlo, tiene que ser un comportamiento ciclico;
            } else if (mensaje.getConversationId().equals("convA1A2")) {
                ran = Integer.parseInt(mensaje.getContent());
            }
        }
