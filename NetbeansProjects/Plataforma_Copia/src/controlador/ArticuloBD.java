...
public class ArticuloBD {
    ...
    public int agregarArticulo(Articulo c, int idusuario) {
        ...
        try {
            conexion.obtener();
            PreparedStatement ps = conexion.getCnx().prepareStatement("INSERT INTO articulo VALUES (0,'" + c.getCategoria() + "','" + c.getMarca() + "','" + c.getTitulo() + "','" + c.getTipoprecio() + "','" + c.getDescripcion() + "','" + c.isNuevo()+ "','" + c.isUsado() + "','" + c.getPrecio() + "','" + idusuario + "')");
    ...
    public AuxiliarArticulo informacionArticulo(AuxiliarArticulo p) {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                cdt.setNuevo(rs.getBoolean("nuevo"));
                cdt.setUsado(rs.getBoolean("usado"));
