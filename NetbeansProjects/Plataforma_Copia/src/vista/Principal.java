...
public class Principal extends javax.swing.JFrame {
    ...
    private void micarritoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_micarritoActionPerformed
        Carrito car = new Carrito(lblnombre.getText());
        car.setVisible(true);
    ...
    private void baniadirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_baniadirActionPerformed
        AuxiliarArticulo apcarrito = (AuxiliarArticulo) lcasas.getSelectedValue();
        ArrayList<AuxiliarArticulo> listacarrito = new ArrayList<>();
        if (!listacarrito.isEmpty()) {
            listacarrito.add(apcarrito);
            JOptionPane.showMessageDialog(null, "Añadido con exito");  
        } else {
            for (AuxiliarArticulo listacarrito1 : listacarrito) {
                    if(listacarrito1.equals(apcarrito)){
                        JOptionPane.showMessageDialog(null, "Ya existe en el carrito");
                    }else{
                         listacarrito.add(apcarrito);
                         JOptionPane.showMessageDialog(null, "Añadido con exito"); 
                    }
