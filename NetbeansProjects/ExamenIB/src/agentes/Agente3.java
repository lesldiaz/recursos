...
public class Agente3 extends Agent{
    ...
    class Comportamiento extends Behaviour{
		...
		public void action() {
                        ...
                        System.out.println("Numero Agente 3: " + numero);
                        enviarMensaje(String.valueOf(numero), "Agente1", "convA1A3");
                        ACLMessage mensaje = blockingReceive();
                        if (mensaje.getConversationId().equals("Conf Recibido Agente 3")){
                            bandera=true;
                        }
