...
public class Agente4 extends Agent{
    ...
    class Comportamiento extends Behaviour{
		...
		public void action() {
                    ...
                    System.out.println("Numero Agente 4: " + numero);
                    enviarMensaje(String.valueOf(numero), "Agente1", "convA1A4");
                    ACLMessage mensaje = blockingReceive();
                    if (mensaje.getConversationId().equals("Conf Recibido Agente 4")){
                            bandera=true;
                    }
