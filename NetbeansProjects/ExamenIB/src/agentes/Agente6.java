...
public class Agente6 extends Agent{
    ...
    class Comportamiento extends Behaviour{
		...
		public void action() {
                    ...
                    if (mensaje.getConversationId().equals("convA1A6")){
                        int suma = Integer.parseInt(mensaje.getContent());
                        System.out.println("Suma Recibida Agente 6: "+ suma);
                        if (suma < 10){
                            enviarMensaje("0", "Agente1", "convA1A6");
                            bandera=true;
                        } else {
                           enviarMensaje( "1", "Agente1", "convA1A6");
                            bandera=true; 
                        }
                    }
		}
