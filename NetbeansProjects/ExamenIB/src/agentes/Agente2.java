...
public class Agente2 extends Agent{
    ...
    class Comportamiento extends Behaviour{
		...
		public void action() {
                        ...
                        System.out.println("Numero Agente 2: " + numero);
                        enviarMensaje(String.valueOf(numero), "Agente1", "convA1A2");
                        ACLMessage mensaje = blockingReceive();
                        if (mensaje.getConversationId().equals("Conf Recibido Agente 2")){
                            bandera=true;
                    }
