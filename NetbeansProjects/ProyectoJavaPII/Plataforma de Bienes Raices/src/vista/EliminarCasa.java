...
public class EliminarCasa extends javax.swing.JFrame {
     ...
     */
    public EliminarCasa(Usuario u) {
        initComponents();
        setLocationRelativeTo(null);
        aux = u;
        Object[] propiedades;
        propiedades = pbd.nombrePropiedades(u).toArray();
        DefaultComboBoxModel model = new DefaultComboBoxModel(propiedades);
        cbpropiedades.setModel(model);
    }
    ...
    private void initComponents() {
        ...
        cbpropiedades.setFont(new java.awt.Font("Arial Rounded MT Bold", 0, 12)); // NOI18N
        cbpropiedades.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Propiedad 1", "Propiedad 2", "...", "Propiedad n" }));
        jPanel1.add(cbpropiedades);

        jLabel2.setFont(new java.awt.Font("Arial Rounded MT Bold", 0, 12)); // NOI18N
        jLabel2.setText("Razon de Eliminacion:");
        jPanel1.add(jLabel2);

        cbrazon.setFont(new java.awt.Font("Arial Rounded MT Bold", 0, 12)); // NOI18N
        cbrazon.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Propiedad Vendida", "No en Venta", "Otro" }));
        jPanel1.add(cbrazon);
    ...
    private void btnsiguienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsiguienteActionPerformed
        String nombre = (String) cbpropiedades.getSelectedItem();
        int valor;
        int valorp;
        int trans;
        if (cbrazon.getSelectedIndex() == 0) {
            valor = ubd.cambiarTransacciones(aux);
            if (valor == -1) {
                JOptionPane.showMessageDialog(null, "Error en el cambio de transacciones");
            } else {
            ...
            valorp = pbd.eliminarPropiedad(aux, nombre);
            if (valorp == -1) {
                JOptionPane.showMessageDialog(null, "Error en la Elimiacion");
            } else {
                JOptionPane.showMessageDialog(null, "Eliminacion Exitosa");
                System.err.println(aux.getTransacciones());
                if (aux.getTransacciones() == 10) {
                    new Principal(aux).setVisible(true);
                    dispose();
                } else {
                    trans = aux.getTransacciones();
                    trans++;
                    System.err.println(trans);
                    aux.setTransacciones(trans);
                    new Principal(aux).setVisible(true);
                    dispose();
                }
            }
