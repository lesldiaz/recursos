...
public class Registro extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        rbci.setText("C.I.");
        rbci.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                rbciMouseClicked(evt);
            }
        });
        ...
        rbpasa.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                rbpasaMouseClicked(evt);
            }
        });
        ...
        jLabel8.setText("<html>Telefono Convencional <small>(con el codigo provincial)</small>: ");
        jPanel1.add(jLabel8);
...
//            Logger.getLogger(Registro.class.getName()).log(Level.SEVERE, null, ex);
        ...
        if (!camposVacios.isEmpty()) {
            ...
            if (tipodoc == true) {
                boolean existe = validar.verificarCedula(docide);
                if (existe == true) {
                    cedulaPas = docide;
            ...
            if (pass.length() <= 8) {
                ...
                u.setCelular(cel);
                u.setTelefonoconvencional(telefono);
                u.setContrasenia(passEncrip);
                u.setTransacciones(0);
                if (ubd.comprobar(docide, email)) {
                    conexion = new Conexion();
                    ubd.setConexion(conexion);
                    aux = ubd.agregarUsuario(u);
                    if (aux == -1) {
    ...
    private void btncancelarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btncancelarActionPerformed
        new Principal(new Usuario("", "", "", "", "", "", 0, 0, 0)).setVisible(true);
        dispose();
    ...
    private void txtdocideKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtdocideKeyTyped
        ...
        if (rbpasa.isSelected()) {
                if ((car < '0' || car > '9') && (car < 'A' || car > 'Z') && (car != 'Ñ') && (car != (char) KeyEvent.VK_BACK_SPACE) && (car != (char) KeyEvent.VK_SPACE)) {
                    getToolkit().beep();
                    evt.consume();
                }
            }
    ...
    private void rbciMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_rbciMouseClicked
        txtdocide.setText("");
    }//GEN-LAST:event_rbciMouseClicked

    private void rbpasaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_rbpasaMouseClicked
        txtdocide.setText("");
    }//GEN-LAST:event_rbpasaMouseClicked
