    ...
    class Comportamiento extends Behaviour{
		...
		public void action() {
                try {
                    ...
                    //generar una lista de 10 nodos aleatoriamente();
                    //enviarMensaje(listaleat,"Agente1","convA1A5");
                    if (m.getConversationId().equals("convA1A5") && raiz.getName().equals("Recibido")){
                        bandera=true;
                    }
