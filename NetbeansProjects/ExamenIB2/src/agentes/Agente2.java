    ...
    class Comportamiento extends Behaviour{
		...
		public void action() {
                try {
                    ...
                    //ArrayList<Nodo> lisheu = re.busquedaheuristica(raiz);
                    //enviarMensaje(lisheu,"Agente1","convA1A2");
                    if (m.getConversationId().equals("convA1A2") && raiz.getName().equals("Recibido")){
                        bandera=true;
                    }
