...
public class PerfilUsuario extends javax.swing.JFrame {
     ...
     */
    public PerfilUsuario(User u, String tipo) {
        initComponents();
        this.setSize(400,300);
        setLocationRelativeTo(null);
        setResizable(false);
        lblnombres.setText(u.getNombre());
        lblapellidos.setText(u.getApellido());
        lblventana.setText(tipo);
        lblubicacion.setText(u.getUbicacion());
    }
    ...
    private void initComponents() {
        ...
        lblventana.setFont(new java.awt.Font("Arial Rounded MT Bold", 0, 12)); // NOI18N
        lblventana.setText("Usuario");
        jPanel4.add(lblventana);
